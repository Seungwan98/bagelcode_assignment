...
AgentBoard는 ChatGPT처럼 사용자가 메시지를 보내면 Planner, Engineer, Reviewer가 협업해 답변하고, 그 과정을 채팅형 UI에서 관찰할 수 있는 로컬 실행형 MVP입니다.
...
6. Agents가 답변을 생성하는 동안 하단 composer가 잠기고 현재 작업 indicator와 `취소` 버튼이 표시되는지 확인합니다.
